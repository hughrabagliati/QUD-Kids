...
# Original items
QUD1 = ET_Import.NoExpand("./Eyes/SubjData/ReliabilityCoding/OriginalItems",Timing,PlaceCodes)
...
# Reliability items
QUD2 = ET_Import.NoExpand("./Eyes/SubjData/ReliabilityCoding/RecodedItems",Timing,PlaceCodes)
